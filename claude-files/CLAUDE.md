...
This file provides critical guidance to Claude Code when working with code.

## IMPORTANT LIMITATIONS

- **CANNOT run interactive CLI applications** - The user will test and provide debug output
- Cannot interact with programs that require user input
...
documentation
2. Plan First: Explain your approach before implementing changes
...
- use the web to help find docs, in addition to any other reference material
